---
title: "Introduction to cost-effectiveness Markov model"
output:
  md_document:
...
__Download the repo .zip folder and take a look at the papers.__
...
__Open this up and have a look around to understand how it works and how it matches up with the journal papers.__

Finally, we have recreated this Excel model in R with the script `Markov_model_script.R`.

__Open this up and see if you can understand how it matches with the Excel model. Don't worry about the details just yet. We will be revisiting this code throughout.__
